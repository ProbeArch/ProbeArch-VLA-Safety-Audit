...
Date: 2026-08-12. Scope: `scripts/telemetry_rollout.py`, `scripts/eval_loop.sh`,
`scripts/smoke_test.py`, `scripts/stats.py`, `scripts/plots.py`, plus the
telemetry-consumption side of `scripts/safety_scorer.py` / `scripts/calibrate.py`
...
`python3 scripts/smoke_test.py` exits 1 in the numpy-only synthetic phase:
