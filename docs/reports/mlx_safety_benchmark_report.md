...
### 2.1 `scripts/audit/shared/calibrate.py`
...
### 2.2 `scripts/audit/mlx/mlx_smolvla.py`
...
### 2.3 `scripts/audit/shared/telemetry_rollout.py`
...
*(Note: `scripts/audit/shared/safety_scorer.py` also carries uncommitted local changes — scalar tilt math and class-map handling — which predate this session's work and are part of the same branch.)*
...
python3 scripts/audit/shared/telemetry_rollout.py --device mlx --suite libero_spatial \
